...
export function ProfileAvatarButton({
  ...
  return (
    <Link
      ...
      className="relative z-20 block shrink-0 rounded-full outline-none ring-2 ring-[var(--acid)]/40 ring-offset-2 ring-offset-black transition-transform duration-300 ease-soft hover:scale-[1.04] active:scale-90 focus-visible:ring-[var(--acid)]"
    >
      <span
        aria-hidden
