        ...
        <div className="ml-auto flex items-center gap-2">
          {isStaff ? (
            <Link
              ...
              className="liquid-glass flex size-10 items-center justify-center rounded-full glass-thin transition-[transform,background] duration-300 ease-soft hover:bg-white/6 active:scale-95"
            >
