...
const chipBase =
  "liquid-glass inline-flex shrink-0 items-center gap-1.5 rounded-pill px-3.5 py-[7px] text-[12.5px] font-medium tracking-[-0.02em] transition-[color,background,box-shadow,transform] duration-300 ease-soft hover:scale-[1.03] active:scale-[0.97]";
